...
function m_add() {
    ...
    if (memory.length != 0) {
        ...
        let s = memory.length;
        memory[s - 1] += parseFloat(display.value);
    }
}
function m_sub() {
    if (memory.length == 0) {
...
function cos() {
    if (deg == 0) {
        display.value = (Math.cos(Math.PI / 180 * display.value)).toFixed(2);
    }
    else {
...
function tan() {
    if (deg == 0) {
        display.value = (Math.tan(Math.PI / 180 * display.value)).toFixed(2);
...
function sec() {
    if (deg == 0) {
        display.value = (1 / Math.cos(Math.PI / 180 * display.value)).toFixed(2);
    }
    else {
        display.value = 1 / Math.cos(display.value).toFixed(2);
    }
}
function csc() {
    if (deg == 0) {

        display.value = (1 / Math.sin(Math.PI / 180 * display.value)).toFixed(2);
    }
    else {
        display.value = 1 / Math.sin(display.value).toFixed(2);
    }
}
function cot() {
    if (deg == 0) {
        display.value = 1 / (Math.tan(Math.PI / 180 * display.value)).toFixed(2);
    }
    else {
        display.value = 1 / Math.tan(display.value).toFixed(2);
    }
}
function sin_inv() {
    if (deg == 0) {
        display.value = (180 / Math.PI * Math.asin(display.value)).toFixed(2);
    }
    else {
        display.value = Math.asin(display.value).toFixed(2);
    }
}
function cos_inv() {
    if (deg == 0) {
        display.value = (180 / Math.PI * Math.acos(display.value)).toFixed(2);
    }
    else {
        display.value = Math.acos(display.value).toFixed(2);
    }
}
function tan_inv() {
    if (deg == 0) {
        display.value = (180 / Math.PI * Math.atan(display.value)).toFixed(2);
    }
    else {
        display.value = Math.atan(display.value).toFixed(2);
    }
}
function sec_inv() {
    if (deg == 0) {
        display.value = (180 / Math.PI * (Math.acos(1 / display.value))).toFixed(2);
    }
    else {
        display.value = 1 / Math.acos(display.value).toFixed(2);
    }
}
function csc_inv() {
    if (deg == 0) {
        display.value = (180 / Math.PI * (Math.asin(1 / display.value))).toFixed(2);
    }
    else {
        display.value = 1 / Math.asin(display.value).toFixed(2);
    }
}
function cot_inv() {
    if (deg == 0) {
        ...
        display.value = 1 / Math.atan(display.value).toFixed(2);
    }
}
function sinh() {
    display.value = (Math.sinh(display.value)).toFixed(2);
}
function cosh() {
    display.value = (Math.cosh(display.value)).toFixed(2);
}
function tanh() {
    display.value = (Math.tanh(display.value)).toFixed(2);
}
function sech() {
    display.value = (1 / Math.cosh(display.value)).toFixed(2);
}
function csch() {
    display.value = (1 / Math.sinh(display.value)).toFixed(2);
}
function coth() {
    display.value = (1 / Math.tanh(display.value)).toFixed(2);
}
function sin_invh() {
    display.value = (Math.asinh(display.value)).toFixed(2);
}
function cos_invh() {
    display.value = (Math.acosh(display.value)).toFixed(2);
}
function tan_invh() {
    display.value = (Math.atanh(display.value)).toFixed(2);
}
function sec_invh() {
    display.value = (1 / Math.acosh(display.value)).toFixed(2);
}
function csc_invh() {
    display.value = (1 / Math.asinh(display.value)).toFixed(2);
}
function cot_invh() {
    display.value = (1 / Math.atanh(display.value)).toFixed(2);
}
